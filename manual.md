...
Radworks is governed by on-chain and off-chain governance processes & xyz. These processes together make up Radworks' **governance system**. Holders of Radworks' native governance token ($RAD) can participate in governance by creating, discussing and voting on RAD Governance Proposals (RGPs).
